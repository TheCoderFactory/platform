...
class WeeksControllerTest < ActionController::TestCase
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post :create, week: { active: @week.active, intro: @week.intro, number: @week.number, title: @week.title }
    end
  ...
  test "should update week" do
    patch :update, id: @week, week: { active: @week.active, intro: @week.intro, number: @week.number, title: @week.title }
    assert_redirected_to week_path(assigns(:week))
  end
