...
class ReadingsControllerTest < ActionController::TestCase
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post :create, reading: { intro: @reading.intro, title: @reading.title, url: @reading.url, week_id: @reading.week_id }
    end
  ...
  test "should update reading" do
    patch :update, id: @reading, reading: { intro: @reading.intro, title: @reading.title, url: @reading.url, week_id: @reading.week_id }
    assert_redirected_to reading_path(assigns(:reading))
  end
